package io.github.restserver.stubs.matrix;
...
public final class computeGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest,
      io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse> getMultiplyRowByColumnMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "multiplyRowByColumn",
      requestType = io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest.class,
      responseType = io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest,
      io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse> getMultiplyRowByColumnMethod() {
    io.grpc.MethodDescriptor<io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest, io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse> getMultiplyRowByColumnMethod;
      ...
      synchronized (computeGrpc.class) {
        if ((getMultiplyRowByColumnMethod = computeGrpc.getMultiplyRowByColumnMethod) == null) {
          computeGrpc.getMultiplyRowByColumnMethod = getMultiplyRowByColumnMethod = 
              io.grpc.MethodDescriptor.<io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest, io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "compute", "multiplyRowByColumn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse.getDefaultInstance()))
  ...
  public static abstract class computeImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void multiplyRowByColumn(io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest request,
        io.grpc.stub.StreamObserver<io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest,
                io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse>(
  ...
  public static final class computeBlockingStub extends io.grpc.stub.AbstractStub<computeBlockingStub> {
    ...
    /**
     */
    public io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse multiplyRowByColumn(io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest request) {
  ...
  public static final class computeFutureStub extends io.grpc.stub.AbstractStub<computeFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse> multiplyRowByColumn(
        io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MULTIPLY_ROW_BY_COLUMN:
          serviceImpl.multiplyRowByColumn((io.github.restserver.stubs.matrix.Matrix.multiplyBlockRequest) request,
              (io.grpc.stub.StreamObserver<io.github.restserver.stubs.matrix.Matrix.multiplyBlockResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class computeBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.restserver.stubs.matrix.Matrix.getDescriptor();
    }
